...
(struct LDXR (size l rs o0 rt2 rn rt)
  #:transparent
  #:property prop:in-feature #hash()
  #:property prop:into-int LDXR->int
  #:property prop:try-from-int int->LDXR
)

(provide (struct-out LDXR))

(define int->LDXRB/struct int->LDXR/struct)
...
(struct LDXRB (size l rs o0 rt2 rn rt)
  #:transparent
  #:property prop:in-feature #hash()
  #:property prop:into-int LDXRB->int
  #:property prop:try-from-int int->LDXRB
)

(provide (struct-out LDXRB))

(define int->LDXRH/struct int->LDXR/struct)
...
(struct LDXRH (size l rs o0 rt2 rn rt)
  #:transparent
  #:property prop:in-feature #hash()
  #:property prop:into-int LDXRH->int
  #:property prop:try-from-int int->LDXRH
)

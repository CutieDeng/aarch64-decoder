...
(define int->LDARH/struct int->LDAR/struct)
...
(struct LDARH (size l rs o0 rt2 rn rt)
  #:transparent
  #:property prop:in-feature #hash()
  #:property prop:into-int LDARH->int
  #:property prop:try-from-int int->LDARH
)

(provide (struct-out LDARH))

...
(struct LD2R (q l r o2 opcode s size rn rt)
  #:transparent
  #:property prop:in-feature #hash()
  #:property prop:into-int LD2R->int
  #:property prop:try-from-int int->LD2R
)

(provide (struct-out LD2R))

(define int->LD2R/Post/struct int->LD1R/Post/struct)

(define (int->LD2R/Post i)
  (cond [(nand
    (equal? (bitwise-bit-field i 31 32) 0)
    (equal? (bitwise-bit-field i 23 30) #x1b)
    (equal? (bitwise-bit-field i 22 23) 1)
...
(struct LD2R/Post (q l r rm opcode s size rn rt)
  #:transparent
  #:property prop:in-feature #hash()
  #:property prop:into-int LD2R/Post->int
  #:property prop:try-from-int int->LD2R/Post
)
...
(define int->LD4R/struct int->LD1R/struct)
...
(define (int->LD4R i)
  ...
  [else (apply LD4R (int->LD4R/struct i))])
)

(define (LD4R->int ld3)
  (match-define (LD4R q l r o2 opcode s size rn rt) ld3)
  (bitwise-ior
    (arithmetic-shift q 30)
    (arithmetic-shift #x1a 23)
    (arithmetic-shift l 22)
...
(struct LD4R (q l r o2 opcode s size rn rt)
  #:transparent
  #:property prop:in-feature #hash()
  #:property prop:into-int LD4R->int
  #:property prop:try-from-int int->LD4R
)

(provide (struct-out LD4R))

(define int->LD4R/Post/struct int->LD1R/Post/struct)

(define (int->LD4R/Post i)
  (cond [(nand
    (equal? (bitwise-bit-field i 31 32) 0)
    (equal? (bitwise-bit-field i 23 30) #x1b)
    (equal? (bitwise-bit-field i 22 23) 1)
  ...
  [else (apply LD4R/Post (int->LD4R/Post/struct i))])
)

(define (LD4R/Post->int ld3)
  (match-define (LD4R/Post q l r rm opcode s size rn rt) ld3)
  (bitwise-ior
    (arithmetic-shift q 30)
    (arithmetic-shift #x1b 23)
    (arithmetic-shift l 22)
...
(struct LD4R/Post (q l r rm opcode s size rn rt)
  #:transparent
  #:property prop:in-feature #hash()
  #:property prop:into-int LD4R/Post->int
  #:property prop:try-from-int int->LD4R/Post
)

(provide (struct-out LD4R/Post))

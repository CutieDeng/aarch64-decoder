...
(define int->LDAXRH/struct int->LDAXR/struct)
...
(struct LDAXRH (size l rs o0 rt2 rn rt)
  #:transparent
  #:property prop:in-feature #hash()
  #:property prop:into-int LDAXRH->int
  #:property prop:try-from-int int->LDAXRH
)

(provide (struct-out LDAXRH))

(define (int->LDAXP/struct i)
...
(struct LDAXP (sz l rs o0 rt2 rn rt)
  #:transparent
  #:property prop:in-feature #hash()
  #:property prop:into-int LDAXP->int
  #:property prop:try-from-int int->LDAXP
)

(provide (struct-out LDAXP))

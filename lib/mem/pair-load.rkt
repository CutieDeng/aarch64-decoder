...
(define (int->LDP i)
  ...
  [else (apply LDP (int->LDP/struct i))])
)

(define (LDP->int l)
  (match-define (LDP opc l imm7 rt2 rn rt) l)
  (bitwise-ior
...
(struct LDP (opc l imm7 rt2 rn rt)
  #:transparent
  #:property prop:in-feature #hash()
  #:property prop:into-int LDP->int
  #:property prop:try-from-int int->LDP
)

(provide (struct-out LDP))

...
(define (int->STLXR i)
  ...
  [else (apply STLXR (int->STLXR/struct i))])
)

(define (STLXR->int stlxr)
  (match-define (STLXR size l rs o0 rt2 rn rt) stlxr)
  (bitwise-ior
...
(struct STLXR (size l rs o0 rt2 rn rt)
  #:transparent
  #:property prop:in-feature #hash()
  #:property prop:into-int STLXR->int
  #:property prop:try-from-int int->STLXR
)
...
(define (STLXRB->int stlxr)
  (match-define (STLXRB size l rs o0 rt2 rn rt) stlxr)
  (bitwise-ior
    (arithmetic-shift size 30)
    (arithmetic-shift #x8 24)
    (arithmetic-shift l 22)
...
(define int->STLXRH/struct int->STLXR/struct)
...
(define (int->STLXRH i)
  ...
  [else (apply STLXRH (int->STLXRH/struct i))])
)

(define (STLXRH->int stlxr)
  (match-define (STLXRH size l rs o0 rt2 rn rt) stlxr)
  (bitwise-ior
    (arithmetic-shift size 30)
    (arithmetic-shift #x8 24)
    (arithmetic-shift l 22)
...
(struct STLXRH (size l rs o0 rt2 rn rt)
  #:transparent
  #:property prop:in-feature #hash()
  #:property prop:into-int STLXRH->int
  #:property prop:try-from-int int->STLXRH
)

(provide (struct-out STLXRH))

(define (int->STLXP/struct i)
...
(define (int->STLXP i)
  ...
  [else (apply STLXP (int->STLXP/struct i))])
)

(define (STLXP->int stlxr)
  (match-define (STLXP sz l rs o0 rt2 rn rt) stlxr)
  (bitwise-ior
...
(struct STLXP (sz l rs o0 rt2 rn rt)
  #:transparent
  #:property prop:in-feature #hash()
  #:property prop:into-int STLXP->int
  #:property prop:try-from-int int->STLXP
)

(provide (struct-out STLXP))
